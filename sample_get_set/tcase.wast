(module
 ...
 (data (i32.const 8832) "userdetail\00")
 ...
 (data (i32.const 8928) "getData failed!\00")
 ...
 (export "_GLOBAL__sub_I_tcase.cpp" (func $_GLOBAL__sub_I_tcase.cpp))
 (func $_GLOBAL__sub_I_tcase.cpp
 ...
 (func $reguser (result i32)
  ...
  (i32.store16
   ...
   (i32.load16_u offset=8840 align=1
    (i32.const 0)
   )
  )
   ...
   (block $label$1
    ...
    (set_local $2
     (select
      (i32.const 0)
      (i32.const -3)
      (call $_Z8saveDataI10UserDetailA20_cEjRT_PcRT0_
       (i32.add
        (get_local $3)
        (i32.const 16)
       )
 ...
 (func $_Z8saveDataI10UserDetailA20_cEjRT_PcRT0_ (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i64)
  ...
  (block $label$0
   (block $label$1
     ...
     (block $label$3
      (block $label$4
       (block $label$5
        ...
        (br_if $label$4
         (i32.eqz
          (call $_Z10parseParamI8SayHelloEjRT_
           (i32.add
            (get_local $7)
            (i32.const 56)
           )
    ...
    (block $label$11
     (br_if $label$11
      (i32.eqz
       (call $_Z7getDataIA20_c10UserDetailEjPcyS2_yRT_yRT0_
        (i32.add
         (get_local $7)
         (i32.const 80)
        )
 ...
 (func $_Z10parseParamI8SayHelloEjRT_ (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $_Z7getDataIA20_c10UserDetailEjPcyS2_yRT_yRT0_ (param $0 i32) (param $1 i64) (param $2 i32) (param $3 i64) (param $4 i32) (param $5 i64) (param $6 i32) (result i32)
  (local $7 i32)
  (local $8 i32)
  (local $9 i32)
  (i32.store offset=4
