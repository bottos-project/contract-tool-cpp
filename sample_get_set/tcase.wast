(module
 ...
 (data (i32.const 8864) "pack failed\00")
 (data (i32.const 8880) "save db failed\00")
 (data (i32.const 8896) "ERROR: Get my contract name failed.\00")
 (data (i32.const 8944) "getData failed!\00")
  ...
  (block $label$2
   (block $label$3
    ...
    (i32.store16
     ...
     (i32.load16_u offset=8892 align=1
      (i32.const 0)
     )
    )
    (i32.store
